...
for m in (100,200,400,800):
    ...
    path_train_err = 'results/UAI4_s'+str(s)+'_m'+ str(m) + 'train.txt'
    path_test_err1 = 'results/UAI4_s'+str(s)+'_m'+ str(m)+'_mtest'+ str(mtest1) + 'test.txt'
    path_test_err2 = 'results/UAI4_s' + str(s) + '_m' + str(m) + '_mtest' + str(mtest2) + 'test.txt'
    path_test_err3 = 'results/UAI4_s' + str(s) + '_m' + str(m) + '_mtest' + str(mtest3) + 'test.txt'
    path_test_err4 = 'results/UAI4_s' + str(s) + '_m' + str(m) + '_mtest' + str(mtest4) + 'test.txt'
